...
import proImg from '../../assets/yogendra-singh-HrpYHchKb5Y-unsplash.jpg';
import {
  RiChat1Line,
  RiToolsLine,
  RiChat3Line,
...
import img from "../../assets/undraw_social_life_re_x7t5.svg";
...
const Content = () => {
  ...
  return (
    <div className={`smd__content ${dark && "dark"}`}>
      <div className="row content-header">
        <FiSettings className="cog" />
        <h1 className="txt-head">Notifications</h1>
      ...
      <div className="row content-header">
        <Card Icon={AiOutlineUsergroupAdd} title="Followers" value="112" />
        <Card Icon={RiChat3Line} title="Messages" value="+ 18" />
        <Card Icon={AiOutlineLike} title="Likes" value="+ 400" />
      ...
      <div className="row square">
        <Analytics title="New Followers" value="+20" illustration={img} />
      </div>
      ...
      <svg
        ...
        <div className="admin">
          ...
          <div className="info">
            ...
            <span className="admin-about">Web Developer</span>
          </div>
